...
public class HBaseClientOperations {
    ...
    private void createTable(Admin admin) throws IOException {
        ...
        HColumnDescriptor Hfamily1=new HColumnDescriptor(family1);
        HColumnDescriptor Hfamily2 = new HColumnDescriptor(family2);
        //set TTL and compression
        Hfamily1.setTimeToLive(2560);
        Hfamily1.setCompressionType(Algorithm.GZ);
        Hfamily2.setTimeToLive(2560);
        Hfamily2.setCompressionType(Algorithm.GZ);
        hTableDescriptor.addFamily(Hfamily1);
        hTableDescriptor.addFamily(Hfamily2);
